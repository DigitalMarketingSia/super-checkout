...
export const CoursePlayer = ({ forcedSlug }: { forcedSlug?: string } = {}) => {
    ...
    const loadData = async (contentId: string) => {
        ...
        try {
            ...
            // ... (rest of logic as assumed correct, let's keep it but just wrap the try/catch/finally correctly here in this snippets, 
            // wait, I can't see the middle part easily to replace it all. 
            // I should just insert the state at top and the render at bottom.
