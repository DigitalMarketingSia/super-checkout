            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="bg-[#1A1D21] rounded-xl p-6 border border-white/5 flex flex-col items-center text-center">
                        ...
                        <h2 className="text-xl font-bold text-white mb-1">{user?.user_metadata?.full_name || 'Usuário'}</h2>
                ...
                <div className="md:col-span-2">
                    <div className="bg-[#1A1D21] rounded-xl p-6 border border-white/5 h-full">
                        <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                            ...
                            Minhas Assinaturas e Compras
                        </h3>

                        {accessGrants.length === 0 ? (
                            <div className="text-center py-12 text-gray-500">
                                <p>Nenhuma assinatura ou compra ativa encontrada.</p>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <h4 className="font-bold text-white text-lg">
                                                    {grant.product_id ? 'Produto / Assinatura' : 'Conteúdo Avulso'}
                                                </h4>
                                            </div>
                                            <p className="text-gray-400 text-sm flex items-center gap-1">
                                                <Calendar className="w-3 h-3" />
                                                Acesso liberado em: {new Date(grant.granted_at).toLocaleDateString()}
                                            </p>
                                        </div>
