                     ...
                     <Card key={wh.id} noPadding className="group overflow-hidden transition-all hover:border-primary/30">
                        <div className="p-6 flex flex-col lg:flex-row items-start lg:items-center gap-6">
                           ...
                           <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-3 mb-1">
                                 ...
                                 <span className={`text-[10px] px-2 py-0.5 rounded font-mono font-bold ${
                                    wh.method === 'POST' ? 'bg-blue-500/20 text-blue-400' : 
                           ...
                           <div className="hidden lg:block text-right min-w-[140px]">
                              ...
                              {wh.last_fired_at ? (
                                 <>
                                    ...
                                    <div className={`text-xs font-bold mt-1 inline-flex items-center gap-1 ${
                                       wh.last_status && wh.last_status >= 200 && wh.last_status < 300 ? 'text-green-500' : 'text-red-500'
                                    }`}>
                           ...
                           <div className="flex items-center gap-2 self-end lg:self-center">
                              ...
                              <button onClick={() => handleDelete(wh.id)} className="p-2 hover:bg-red-500/10 rounded-lg text-gray-400 hover:text-red-500 transition-colors">
                     ...
                     {logs.length === 0 ? (
                        ...
                        logs.map(log => (
                           <tr key={log.id} className="hover:bg-white/5 transition-colors">
                              ...
                              <td className="px-4 py-3">
                                 <button className="text-primary hover:text-white text-xs flex items-center gap-1" onClick={() => alert('Payload Viewer Not Implemented in this Demo')}>
  ...
  "status": "paid"
      ...
      {isModalOpen && (
         <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="bg-[#0F0F13] w-full max-w-4xl rounded-2xl border border-white/10 shadow-2xl flex flex-col max-h-[90vh] animate-in fade-in zoom-in duration-200">
               ...
               {/* Body */}
               <form onSubmit={handleSave} className="flex-1 overflow-y-auto custom-scrollbar flex flex-col lg:flex-row">
                  
                  {/* Left: Configuration */}
                  <div className="flex-1 p-6 space-y-6 border-r border-white/5">
                           ...
                           {AVAILABLE_EVENTS.map(evt => (
                              ...
                              >
                                 ...
                                 <div className={`w-4 h-4 rounded border mr-3 flex items-center justify-center ${
                                    formData.events.includes(evt.id) ? 'bg-primary border-primary' : 'border-gray-500'
                                 }`}>
                  ...
                  {/* Right: Preview & Test */}
                  <div className="w-full lg:w-1/3 bg-black/20 p-6 border-l border-white/5 flex flex-col">
                     ...
                     <div className="mt-6 pt-6 border-t border-white/5">
                        ...
                        {testStatus !== 'idle' && testResult && (
                           <div className={`p-3 rounded-lg border text-xs ${
                              testStatus === 'success' ? 'bg-green-500/10 border-green-500/20' : 'bg-red-500/10 border-red-500/20'
                           }`}>
