...
import { X, User, ShoppingBag, MessageCircle, CreditCard, Calendar, Mail, FileText, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
export const OrderDetailsModal: React.FC<OrderDetailsModalProps> = ({ order, isOpen, onClose }) => {
    ...
    const handleResendEmail = async () => {
        ...
        try {
            ...
            await emailService.sendPaymentApproved(order);
