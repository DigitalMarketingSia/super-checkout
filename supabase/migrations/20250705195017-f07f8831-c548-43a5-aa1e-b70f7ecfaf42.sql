-- Primeiro: atualizar checkouts para usar o gateway que vai permanecer
UPDATE checkouts 
SET gateway_id = '514d66fe-08de-4be0-8afd-3049adc5414f'
WHERE gateway_id = '3ebfa197-d627-4c3b-be02-8f19b91b4b25';

-- Segundo: deletar o gateway duplicado
DELETE FROM gateways 
WHERE type = 'mercado_pago' 
AND id = '3ebfa197-d627-4c3b-be02-8f19b91b4b25';

-- Terceiro: atualizar o gateway restante para ter estrutura consistente
UPDATE gateways 
...
-- Quarto: adicionar coluna environment se não existir
